...
class Feedback extends React.Component {
    ...
    constructor(props){
        super(props);
        this.state={feedback:'',rating:0,msg:'',improvement:'',errorMsg:'',empID:'',eventID:'',bu:''}
    ...
    submitVals(event){
      ...
      if(this.state.rating<3 && this.state.improvement===''){
        ...
        var data ={ empID:this.state.empID,description:this.state.feedback,rating:this.state.rating,eventID:this.state.eventID,businessUnit:this.state.bu,improvement:this.state.improvement};
